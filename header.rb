...
/js/jquery-1.7.2.min.js /images/index/pic1.png /images/welcome/decorate.png /images/index/pic2.png}.each{|x|
#	tasks = Thread.new do
	uri = URI("http://www.chingyu.net#{x}")
	queue << uri	
#	end
       # out=Net::HTTP.get_response(uri)
#	puts uri,out.to_hash
}

get = Thread.new do
  512.times do |i|
    todo = queue.pop
    out=Net::HTTP.get_response(todo)
    puts todo,out.to_hash
  end
end
get.join
